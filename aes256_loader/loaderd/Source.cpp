...
// Input: .\calc.bin (276 bytes shellcode)
// Padded: 288 bytes, Ciphertext: 288 bytes
// Paste into aes256_loader_dll.cpp, replacing kEncryptedShellcode[]

static const unsigned char kEncryptedShellcode[] = {
    
};
...
int main(int argc, char* argv[]) {
    (void)argc; (void)argv;
    // This entry point is used when loaderd is built as an executable
    // For DLL builds, this is ignored in favor of DllMain
    RunPayload();
    return 0;
}
