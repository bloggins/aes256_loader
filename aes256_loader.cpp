// ============================================================
// aes256_loader_dll-aug.cpp — AES-256-CBC shellcode loader (FIXED)
//
// MSVC x64:
//   cl /LD /O2 /GS- /std:c++17 aes256_loader_dll-aug.cpp /link /OUT:aes256_loader-aug.dll
//
// MinGW-w64:
//   x86_64-w64-mingw32-g++ -shared -o aes256_loader_dll-aug.dll aes256_loader_dll-aug.cpp -static -s -O2 -fno-stack-protector
//
// Load (use the exported Run — NOT DllMain):
//   rundll32.exe aes256_loader_dll-aug.dll,Run
// ============================================================
